...
def sign_up():  
    ...
    while new_user in newu:
        ...
        sudb=ms.connect(host='localhost',user='root',passwd='Anusha1011',database='project')
...
def update_pass(user):
    ...
    while up != up_check:
        ...
        updb=ms.connect(host='localhost',user='root',passwd='Anusha1011',database='project')      
...
def del_user(user):
    ...
    if choice not in 'yY':
        ...
        dudb=ms.connect(host='localhost',user='root',passwd='Anusha1011',database='project')      
...
while True:
    ...
    if begin=='a' or begin=='A':
        ...
        sicudb=ms.connect(host='localhost',user='root',passwd='Anusha1011',database='project')
        ...
        while cur_user not in curu:
            ...
            sicpdb=ms.connect(host='localhost',user='root',passwd='Anusha1011',database='project')    
