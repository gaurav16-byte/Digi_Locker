...
def direc():    #create an empty folder for files
    ...
    if 'your db name' not in folder == True:
        os.mkdir('/Users/your mac name/Documents/your db name')
    else:
        pass
direc()
    ...
    while new_user in newu:
        ...
        while ' ' in new_user:
            ...
            while len(new_pas)<=6:
                ...
                sudb.commit()
                sudb.close()
                f=open('/Users/your mac name/Documents/your db name/'+new_user+'.txt','w')
                f.write(encrypt('Welcome to your notepad')+'\n')
                f.close()
                print('Registration successful')

def reading(user):
    with open('/Users/your mac name/Documents/your db name/'+user+'.txt') as f:
        x=f.readlines()
...
def write_details(user):
    with open('/Users/your mac name/Documents/your db name/'+user+'.txt','w') as f:
        write=input('enter details for input')
        f.write(encrypt(write)+'\n')
        print('record written')
        
def append_details(user):
    with open('/Users/your mac name/Documents/your db name/'+user+'.txt','a') as f:
...
def del_user(user):
    ...
    if choice not in 'yY':
        ...
        dudb.commit()
        dudb.close()
        os.remove('/Users/your mac name/Documents/your db name/'+user+'.txt')
