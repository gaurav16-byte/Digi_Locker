...
def direc():    #create an empty folder for files
    ...
    if 'Project' not in folder == True:
        os.mkdir('C:\\Users\\Public\\Project')
    else:
        pass
direc()
...
def sign_up():  
    ...
    while new_user in newu:
        ...
        sudb.commit()
        sudb.close()
        f=open('C:\\Users\\Public\\Project\\'+new_user+'.txt','w')
        f.write(encrypt('Welcome to your notepad')+'\n')
        f.close()
        print('Registration successful')

def reading(user):
    with open('C:\\Users\\Public\\Project\\'+user+'.txt') as f:
        x=f.readlines()
...
def write_details(user):
    with open('C:\\Users\\Public\\Project\\'+user+'.txt','w') as f:
        write=input('enter details for input')
        f.write(encrypt(write)+'\n')
        print('record written')
        
def append_details(user):
    with open('C:\\Users\\Public\\Project\\'+user+'.txt','a') as f:
